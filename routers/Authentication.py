...
from services.Authentication import login_service, get_current_user,register_user_service, confirm_user_service, delete_user_service, logout_service, change_password_service
...
@router.post("/auth/change-password/{token}")
